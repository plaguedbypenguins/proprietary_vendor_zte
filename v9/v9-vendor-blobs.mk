...
# This file is generated by device/zte/v9/setup-makefiles.sh

PRODUCT_COPY_FILES := \
    vendor/zte/v9/proprietary/lib/libloc.so:obj/lib/libloc.so

PRODUCT_COPY_FILES += \
    vendor/zte/v9/proprietary/bin/qmuxd:system/bin/qmuxd \
    vendor/zte/v9/proprietary/lib/libauth.so:system/lib/libauth.so \
    vendor/zte/v9/proprietary/lib/libcm.so:system/lib/libcm.so \
    vendor/zte/v9/proprietary/lib/libdiag.so:system/lib/libdiag.so \
    vendor/zte/v9/proprietary/lib/libdll.so:system/lib/libdll.so \
    vendor/zte/v9/proprietary/lib/libdsm.so:system/lib/libdsm.so \
    vendor/zte/v9/proprietary/lib/libdss.so:system/lib/libdss.so \
    vendor/zte/v9/proprietary/lib/libgsdi_exp.so:system/lib/libgsdi_exp.so \
    vendor/zte/v9/proprietary/lib/libgstk_exp.so:system/lib/libgstk_exp.so \
    vendor/zte/v9/proprietary/lib/libmmgsdilib.so:system/lib/libmmgsdilib.so \
    vendor/zte/v9/proprietary/lib/libnv.so:system/lib/libnv.so \
    vendor/zte/v9/proprietary/lib/liboncrpc.so:system/lib/liboncrpc.so \
    vendor/zte/v9/proprietary/lib/libpbmlib.so:system/lib/libpbmlib.so \
    vendor/zte/v9/proprietary/lib/libqmi.so:system/lib/libqmi.so \
    vendor/zte/v9/proprietary/lib/libqueue.so:system/lib/libqueue.so \
    vendor/zte/v9/proprietary/lib/libril-qc-1.so:system/lib/libril-qc-1.so \
    vendor/zte/v9/proprietary/lib/libril-qcril-hook-oem.so:system/lib/libril-qcril-hook-oem.so \
    vendor/zte/v9/proprietary/lib/libwms.so:system/lib/libwms.so \
    vendor/zte/v9/proprietary/lib/libwmsts.so:system/lib/libwmsts.so \
    vendor/zte/v9/proprietary/lib/liboemcamera.so:system/lib/liboemcamera.so \
    ...
    vendor/zte/v9/proprietary/lib/libOpenVG.so:system/lib/libOpenVG.so \
    vendor/zte/v9/proprietary/lib/libsc-a2xx.so:system/lib/libsc-a2xx.so \
    vendor/zte/v9/proprietary/lib/libloc.so:system/lib/libloc.so \
    ...
    vendor/zte/v9/proprietary/lib/libomx_avcdec_sharedlibrary.so:system/lib/libomx_avcdec_sharedlibrary.so \
    vendor/zte/v9/proprietary/lib/libomx_m4vdec_sharedlibrary.so:system/lib/libomx_m4vdec_sharedlibrary.so \
    vendor/zte/v9/proprietary/lib/libomx_mp3dec_sharedlibrary.so:system/lib/libomx_mp3dec_sharedlibrary.so \
    vendor/zte/v9/proprietary/lib/libomx_sharedlibrary.so:system/lib/libomx_sharedlibrary.so
